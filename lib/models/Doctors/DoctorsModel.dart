...
class DoctorsModel {
  ...
  DoctorsModel({
    required this.idDoctor, required this.nombreCompleto, required this.numColegioMed, 
    required this.direccion, required this.foto,required this.especialidad,
    required this.documento,required this.estado
  });  
